import { Box, Buttons, ButtonsBox, Field, InfoBox, Inputn, Labeln, Optionn, SectionBox, SectionTitle, Selectn, TextArean, Title } from "./styles"
import React from 'react';
import { useForm } from 'react-hook-form';
import { Endereco } from "../../services/api/enderecoService";
                ...
                <SectionBox>
                    ...
                    <Field>
                        ...
                        <InfoBox>
                            ...
                            <TextArean placeholder="Digite suas observações aqui..." {...register('observacoes')} />
                        </InfoBox>
                    </Field>
                </SectionBox>
                <ButtonsBox>
                    <Buttons>Sair<BsArrowBarRight /></Buttons>
                    <Buttons type="reset">Limpar<BsEraser /></Buttons>
                    <Buttons type="submit">Enviar<BsSend /></Buttons>
                </ButtonsBox>
            </form>
        </Box>
    </>)
