        ...
        {hasAberturaValue === 1 && (
          <>
            <Field>
              ...
              <InfoBox>
                <Labeln>Hora</Labeln>
                <Inputn type="time" {...register("SB_HSHoraAbertura")} />
              </InfoBox>
              <InfoBox>
                <Labeln>Aberto Por</Labeln>
                <Inputn type="text" {...register("SB_AbertoPor")} />
              </InfoBox>
              <InfoBox>
                <Labeln>Rede</Labeln>
                <Inputn type="text" {...register("SB_Rede")} />
              </InfoBox>
            </Field>
            <Field>
              <InfoBox>
                <Labeln>ØAberto</Labeln>
                <Inputn type="text" {...register("SB_OAberto")} />
              </InfoBox>
              <InfoBox>
                <Labeln>Utilizou MZ</Labeln>
                <Inputn type="text" {...register("SB_UtilizouMZ")} />
              </InfoBox>
              <InfoBox>
              ...
              <InfoBox>
                ...
                <Inputn type="text" {...register("SB_ManobraWFM")} />
              </InfoBox>
            </Field>
            <Field>
              <InfoBox>
                <Labeln>Qtde. Ligações</Labeln>
                <Inputn type="number" {...register("SB_QTDEligacoes")} />
              </InfoBox>
              <InfoBox>
                <Labeln>Executante</Labeln>
                <Inputn type="text" {...register("SB_Executante")} />
              </InfoBox>
              <InfoBox>
                <Labeln>Previsão</Labeln>
                <Inputn type="time" {...register("SB_Previsao")} />
              </InfoBox>
              <InfoBox>
